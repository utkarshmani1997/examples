...
Name: comment
Parent: post
pkgPath: server/user/post/comment
*/

var logger = log.New()

func SetLogger(l log.Logger) {
	ldcfg := viper.GetStringMap("log-config.resources.user.post.comment.default")
	...
	lcfg := viper.GetStringMap("log-config.resources.user.post.comment")
